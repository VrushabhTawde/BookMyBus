	...
	<body>
		...
		<section class="service-area section-gap relative">
			...
			<div class="container">
					...
					<div class="col-lg-10">
						...
						<div class="card">
							...
							<div class="card-body" align="center">
								...
								<div class="offset-lg-1 col-lg-10 offset-sm-0 col-sm-12">
									<div class="row">
										...
										<div class="col-md-3 copy-link">
											<button onclick="myFunction()" class="btn btn-outline-primary"><i class="fas fa-copy"></i>  Copy happy Holidays Code No</button>
										</div>
									</div>
								</div>
								...
								<!-- <div class="col-md-3 copy-link">
											<button onclick="myFunction1()" class="btn btn-outline-primary"><i class="fas fa-copy"></i> Copy happy Holidays Code No</button>
										</div> -->



								<div class="col-12 bigger-title text-orange">
								<h4><b> <p>Discounted Ammount:</p></b></h4>
								<?
								?>
									<h3 ><p>$<?= number_format($total-100,0,',','.') ;?></p></h3>
								</div>
								...
								<a href="<?= base_url('tiket/konfirmasi/'.$tiket[0]['kd_order'].'/'.$total) ?>" class="btn btn-info pull-center">Submit for Payment Confirmation </a>
							</div>
						</div>
					</div>
				</section>
				...
				swal("Copy", "Successfully Copied Code", "info");
				}
				// function myFunction1() {
				// var copyText = document.getElementById("HAPPYHOLIDAYS");
				// copyText.select();
				// document.execCommand("copy");
				// swal("Copy", "Successfully Copied Code", "info");
				// }

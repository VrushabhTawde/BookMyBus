...
<head>
	...
	<style>
body {
  background-image: url('https://www.nicepng.com/png/full/247-2477903_south…dias-popular-bus-ticket-booking-company-volvo.png');
}
</style>
</head>
			...
			<div class="row">
				<div class="col-lg-6">
					...
					<div class="card mb-5">
						...
						<img class="img-fluid" src="http://localhost/BusTicket_updated/assets/frontend/img/search.svg" width="100">
							<!-- <i class="fas fa-search"></i>--> Search Tickets <P>Before Buying Tickets, Please have a look>> <b><i data-toggle="modal"
						...
						<div class="card-body">
							...
							<form action="<?php echo base_url() ?>tiket/cekjadwal?>" method="get">
								<div class="form-group">
									<label for="exampleInputEmail1" style="font-size: larger font-weight: 500;">Select Date</label>

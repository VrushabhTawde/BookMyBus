											...
											<div class="card">
												...
												<div class="card-body">
													<form action="<?php echo base_url() ?>tiket/cektiketmu" method="post">
														...
														<hr>
														<div class='form-group'>
														<a style="color:#2b6777;"  href='javascript:history.back()' class='btn btn-default pull-left'>Go Back</a>
														<button class="btn btn-info pull-right">Process Ticket</button>
													</div>
												</form>
												<!-- Log on to codeastro.com for more projects -->
													</div>

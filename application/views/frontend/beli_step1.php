				...
				<div class="row">
					<div class="col-lg-4">
						...
						<div class="card mb-5">
							...
							<div class="card-header" style="font-weight:600;">
								<i class="fas fa-tiket"></i> Get 50% Off upto Rs100
							</div>
							...
							<div class="card-header" style="font-weight:600;">
								<i class="fas fa-info-circle"></i> Drivers Details
							</div>
							<div class="card-body">
								<ul>
									<li>► Drivers Name : <b><?php echo $jadwal['dname'];  ?></b></li>
									<li>► Driver's Mobile:   <b><?php echo $jadwal['dmobile'];  ?></b></li>
									<li>► Driver's Age:  <b><?php echo $jadwal['dage'];  ?></b></li>
											...
											<div class="col-lg-4">
												...
												<div class="card mb-5">
													...
													<div class="alert alert-success" role="alert">
														...
														<div class='btn-group'>
															<a style="color:#2b6777;"  href="<?php echo base_url('tiket/cekjadwal/'.$tanggal.'/'.$asal['kd_tujuan'].'/'.$jadwal['kota_tujuan']) ?>" class='btn btn'>Go Back</a>

					...
					<div class="col-lg-7">
					  ...
					  <div class="card-body" align="center">
					    ...
					    <p><img src="<?php echo base_url('assets/frontend/upload/qrcode/'.$tiket) ?>.png"></p>
					    	<a href="<?php echo base_url('assets/frontend/upload/qrcode/'.$tiket) ?>.png" class="btn btn-secondary" download>Download Qr Code</a> 
					    	<a href="<?php echo base_url('tiket/payment/'.$tiket) ?>" class="btn btn-info">Check Payment</a>
					    <br>

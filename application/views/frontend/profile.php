								...
								<div class="card-body" align="left">
									<div class="row">
										...
										<div class="col-sm-14">
											...
											<p><a href="<?php echo base_url('profile/changepassword/'.$profile['kd_pelanggan']) ?>" class="btn btn-info">Change Password</a></p>
											<p><button data-toggle="modal" data-target="#exampleModal" class="btn btn-info">Edit Account</button></p>
										</div>
									</div>
								</div>
							</div>

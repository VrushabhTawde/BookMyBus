<header id="header" id="home" >
		    <div class="container">
		    	<div class="row align-items-center justify-content-between d-flex">
			      <div id="logo">
			        <a href="<?php echo base_url() ?>"><h3>  <b style="    color: #ffffff;"><img class="img-fluid" src="http://localhost/BusTicket_updated/assets/frontend/img/logo1.png" width="100"></b></h3></a>
			      </div>

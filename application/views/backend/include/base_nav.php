  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('backend/home') ?>">
        ...
        <div class="sidebar-brand-text mx-3"><img class="img-fluid" src="http://localhost/BusTicket_updated/assets/frontend/img/logo2.png" width="100"></div>
        </div>
       
      </a><div class="sidebar-brand-text mx-3" style="color:white;">ADMIN PANEL</div>
